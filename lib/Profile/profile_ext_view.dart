                        ...
                        TextButton(
                          onPressed: () async {
                            ...
                            if (clicked == 0) {
                              ...
                              widget.user['followers'].where((f) =>
                              (f['username'] ==
                                  Provider
                                      .of<UserDB>(context, listen: false)
                                      .username));
                              sendPushMessage(token, '','${Provider.of<UserDB>(context, listen: false).username}' ' unfollowed you');
                            } else {
                              //perform follow
                              await Provider.of<UserDB>(context, listen: false)
                                  .addFollower(
                              ...
                              widget.user['followers'].add({
                                ...
                                Provider
                                    .of<UserDB>(context, listen: false)
                                    .user_email,
                                'followers_count': Provider
                                    .of<UserDB>(context, listen: false)
                                    .followers_count,
                                'following_count': Provider
                                    .of<UserDB>(context, listen: false)
                                    .following_count,
                              });
                              ...
                              sendPushMessage(token, '','${Provider.of<UserDB>(context, listen: false).username}' ' started following you');
                            }
                            setState(() {});
                          },
                          child:
                          (clicked == 0) ? const Text("Follow") : const Text(
                              "Unfollow"),
                          style: TextButton.styleFrom(
                              ...
                              backgroundColor:
                              (clicked == 0) ? Colors.deepOrange : Colors
                                  .lightBlue),
                        ),
                        const SizedBox(height: 10),
                        Container(
